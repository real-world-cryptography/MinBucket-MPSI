...
public:
    ...
    virtual void get_args()
    {
        ...
        total_parties_=total_parties_arg_.getValue();
    }
    ...
    int total_parties() const {
        return total_parties_;
    }
private:
    ...
    TCLAP::ValueArg<int> total_parties_arg_ = TCLAP::ValueArg<int>(
        "", 
        "total_parties", 
