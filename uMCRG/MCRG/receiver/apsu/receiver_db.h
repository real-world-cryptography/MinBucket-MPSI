        ...
        */
        ...
        public:
            ...
            */
            ...
            with the new label.
            */
            void insert_or_assign(const std::vector<std::pair<Item, Label>> &data,int serial_number);
            ...
            */
            void insert_or_assign(const std::pair<Item, Label> &data,int serial_number)
            {
                std::vector<std::pair<Item, Label>> data_singleton{ data };
                insert_or_assign(data_singleton,serial_number);
            }
            ...
            ReceiverDB instance.
            */
            void insert_or_assign(const std::vector<Item> &data,int serial_number);

            /**
            Inserts the given (hashed) item into the database. This function can be used only on an
            unlabeled ReceiverDB instance.
            */
            void insert_or_assign(const Item &data,int serial_number)
            {
                std::vector<Item> data_singleton{ data };
                insert_or_assign(data_singleton,serial_number);
            }

            void my_insert_or_assign(const std::vector<Item> &data,int serial_number);


            void my_set_data(const std::vector<Item> &data,int serial_number)
            {
                clear();
                my_insert_or_assign(data,serial_number);
            }
            ...
            */
            void set_data(const std::vector<std::pair<Item, Label>> &data,int serial_number)
            {
                clear();
                insert_or_assign(data,serial_number);
            }
            ...
            unlabeled ReceiverDB instance.
            */
            void set_data(const std::vector<Item> &data,int serial_number)
            {
                clear();
                insert_or_assign(data,serial_number);
            }
            ...
            */
            void remove(const std::vector<Item> &data,int serial_number);

            /**
            Removes the given (hashed) item from the database.
            */
            void remove(const Item &data,int serial_number)
            {
                std::vector<Item> data_singleton{ data };
                remove(data_singleton,serial_number);
            }
            ...
            */
            Label get_label(const Item &item,int serial_number) const;
