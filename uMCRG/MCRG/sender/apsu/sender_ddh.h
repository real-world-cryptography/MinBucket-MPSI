    ...
    namespace sender {
        ...
        */
        ...
        public:
            ...
            */
            std::pair<std::shared_ptr<kuku::KukuTable>, IndexTranslationTable> Cuckoo_Hash(const std::vector<HashedItem> &items,const std::vector<std::string> &origin_item);

            std::pair<Request, IndexTranslationTable> create_query_1(std::shared_ptr<kuku::KukuTable> cuckoo_ptr, IndexTranslationTable itt,coproto::AsioSocket SenderKKRTSocket);
...
// #endif
        private:
            ...
            */
            ...
            std::vector<oc::block> originitem;
            std::vector<int> index_cuckoo;
